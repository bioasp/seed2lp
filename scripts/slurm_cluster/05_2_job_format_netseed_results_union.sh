...
NETSEED_FORM_RESULT_DIR="${RESULT_DIR}/netseed_formated_results_union"
TOOL="NETSEED"

./05_2_format_results_netseed_union.sh -i $NETSEED_RESULT_DIR -r $NETSEED_FORM_RESULT_DIR -o $OBJECTIVE_DIR -s $SBML_DIR -t $TOOL
