...
########## EXECUTE TARGET ##########
### SPECIFIC ###
sbatch 08_job_run_s2lp_one_solution.sh -c target -m m -s reasoning 
sbatch 08_job_run_s2lp_one_solution.sh -c target -m m -s filter
sbatch 08_job_run_s2lp_one_solution.sh -c target -m m -s guess_check
sbatch 08_job_run_s2lp_one_solution.sh -c target -m m -s guess_check_div